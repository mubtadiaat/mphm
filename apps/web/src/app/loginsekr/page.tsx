        ...
        <div className="flex flex-col items-center text-center space-y-3 mb-6">
          ...
          <div>
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-400/30 text-amber-700 text-[11px] font-extrabold uppercase tracking-wider mb-2 shadow-sm">
              ...
              <span>Software Admin Premium</span>
            </div>
            <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-slate-900">Portal Sekretariat</h1>
            <p className="text-xs text-slate-500 mt-1 font-medium">Super Admin • Sek.Pondok • Sek.Madrasah</p>
          </div>
        </div>
