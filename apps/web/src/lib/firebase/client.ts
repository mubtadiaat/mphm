...
const firebaseConfig = {
  ...
  authDomain: process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN || (typeof window !== "undefined" && window.location.host.includes("p3hm.my.id") ? window.location.host : "m.p3hm.my.id"),
