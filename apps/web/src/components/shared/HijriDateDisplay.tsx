...
export function HijriDateDisplay({ date, className = "", showIcon = true }: HijriDateDisplayProps) {
  ...
  return (
    <div className={`flex items-center gap-2 text-sm text-zinc-600 dark:text-zinc-400 bg-white/80 dark:bg-zinc-900/60 px-4 py-2 border border-zinc-200 dark:border-zinc-800 rounded-xl w-fit shadow-xs ${className}`}>
