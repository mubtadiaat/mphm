...
export function DashboardTab() {
  ...
  const { data: statsData, isLoading } = useDashboardStats(selectedYearId);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 p-6 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl flex flex-col gap-4 shadow-sm relative overflow-hidden">
          <div className="flex flex-col gap-1 z-10">
            <h2 className="text-lg font-bold text-zinc-900 dark:text-white">Distribusi Santri per Jenjang</h2>
            <p className="text-xs text-zinc-400 dark:text-zinc-500">Statistik persebaran santri di berbagai tingkatan.</p>
          </div>
